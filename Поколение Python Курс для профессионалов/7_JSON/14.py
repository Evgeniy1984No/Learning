...
with open('C:/Users/kandz/Downloads/food_services (1).json', encoding='utf-8') as f1:
    data = json.load(f1)
    type_count = {}
    for d in data:
        type_count[d['TypeObject']] = type_count.get(d['TypeObject'], ('', 0))
        if d['SeatsCount'] > type_count[d['TypeObject']][1]:
            type_count[d['TypeObject']] = (d['Name'], d['SeatsCount'])
    [print(f'{d[0]}: {d[1][0]}, {d[1][1]}') for d in sorted(type_count.items())]
