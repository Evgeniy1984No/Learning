...
times_of_purchases_before = list(filter(lambda d: d.hour < 12, times_of_purchases))
print(['После полудня', 'До полудня'][len(times_of_purchases_before) > len(times_of_purchases) - len(times_of_purchases_before)])
