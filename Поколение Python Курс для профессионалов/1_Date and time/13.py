...
dates_times = sorted([datetime.combine(dates[i], times[i]) for i in range(len(dates))], key=lambda d: d.second)
[print(d) for d in dates_times]
# **********************************************************************************************************************
date_times = [datetime.combine(d, t) for d, t in zip(dates, times)]

print(*sorted(date_times, key=lambda dt: dt.second), sep='\n')
