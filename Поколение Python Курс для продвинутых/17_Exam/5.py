...
with open('/home/kandzi/Загрузки/forbidden_words.txt', encoding='utf-8') as check, open('/home/kandzi/Загрузки/' + input(), encoding='utf-8') as file:
    check_words = check.read().split()
    txt = file.read()
    for word in check_words:
        txt = re.sub(word, '*' * len(word), txt, flags=re.IGNORECASE)
    print(txt)
