...
$100
"""
with open('C:/Users/kandz/Downloads/ledger.txt', encoding='utf-8') as file:
    # print('$' + str(sum([int(line[1:].strip()) for line in file.readlines()])))
    # *****************************************************************************************************************
    print('${}'.format(sum(map(lambda x: int(x[1:]), file))))
