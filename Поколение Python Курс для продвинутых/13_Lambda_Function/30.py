"""
Список mixed_list содержит целочисленные и строковые значения. Напишите программу, которая с помощью встроенной функции
 max() находит и выводит наибольшее числовое значение в указанном списке.
...
# lambda возвращает кортеж, сначала сравнивается 1е значение, затем сранение происходит по 2 элементу кортежа
