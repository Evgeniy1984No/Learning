...
0 до
255
255 (включительно), разделённых точками, например,
192.168.1.2
192.168.1.2.
...
ip = input().split('.')
print(ip)
print(all(map(lambda num: int(num) in range(0, 256) if num.isdigit() else False, ip)))
# ****************************************************************************************************************
print(all(map(lambda x: x.isdigit() and int(x) in range(256), input().split('.'))))