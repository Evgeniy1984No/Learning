...
n и
�
m — количество строк и столбцов в матрице, затем элементы матрицы построчно через пробел, затем числа
�
i и
�
...
j, j_1 = [int(j) for j in input().split()]
for elem in matrix:
    elem[j], elem[j_1] = elem[j_1], elem[j]
    print(*elem)
